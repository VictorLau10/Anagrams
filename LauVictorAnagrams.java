...
public class LauVictorAnagrams
{
    ...
    public static ArrayList solutions = new ArrayList();
    public static ArrayList userWords = new ArrayList();
    ...
    public static void setUp() throws InterruptedException
    {
        ...
        String difficultyAnswer = difficultyChoice.nextLine();
    ...
    public static void endingScreen() throws InterruptedException
    {
        ...
        Scanner userSolution = new Scanner(System.in);
        sopl("Would you like to see the solutions? (y / n) ");
        String solutionChoice = userSolution.nextLine();
